...
- [Установка и настройка](#-установка-и-настройка)
  ...
  - [7. Запуск системы](#7-запуск-системы)(ОБЯЗАТЕЛЬНО)
...
### 1. Подготовка сервера(ОБЯЗАТЕЛЬНО)
...
### 2. Клонирование репозитория(ОБЯЗАТЕЛЬНО)
...
### 4. Генерация секретных ключей(ОБЯЗАТЕЛЬНО)
...
### 6. Настройка аутентификации(ОБЯЗАТЕЛЬНО)
...
## 🔒 Безопасность(ЧАСТЬ ОБЯЗАТЕЛЬНО)
